...
public class ReusableMethods {
    ...
    //=======Return a list of string given a list of Web Element(List olarak verilen WEb Elementi String list olarak donduren method====////
    ...
    //=======Returns the Text of the element given an element locator(locator u verilen web elementin text ini donduren ==//
